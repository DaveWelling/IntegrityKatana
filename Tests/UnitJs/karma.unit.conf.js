module.exports = function (config) {
    config.set({
		...
		files: [
            ...
            { pattern: '../tests/UnitJs/node_modules/angular-mocks/angular-mocks.js', watched: false, included: true, served: true },
            { pattern: '../tests/UnitJs/node_modules/sinon/pkg/sinon.js', watched: false, included: true, served: true },
            'src/app.js',
            'src/**/*.js',
            'src/**/*.html',
			'../tests/UnitJs/tests/**/*.js'
		],
